...
from reportlab.platypus import Table, PageBreak, SimpleDocTemplate
...
class single_pdf_sheet(object):
    ...
    def create_sheet(self):
        ...
        ##		intestazione2 = Paragraph("<b>HFF_system</b>", styNormal)
        ##
        ##		#1 row
        ...
        cell_schema = [  # 00, 01, 02, 03, 04, 05, 06, 07, 08, 09 rows
            ...
            [paragraph_list[2], '01', '02', paragraph_list[3], '04', paragraph_list[4], '06', '07', paragraph_list[4],
             '09'],
            # 1 row ok
            [paragraph_list[5], '01', '02', paragraph_list[6], '04', '05', paragraph_list[7], '07', '08', '09'],
            # 2 row ok
            [paragraph_list[8], '01', '02', '03', '04', '05', '06', '07', '08', '09'],  # 3 row ok
            [paragraph_list[9], '01', '02', '03', '04', '05', '06', '07', '08', '09'],  # 4 row ok
            [paragraph_list[10], '01', '02', '03', '04', '05', paragraph_list[10], '07', '08', '09'],
            # 5 row ok
            ['https://sites.google.com/site/hff_system_/', '01', '02', '03', '04', '05', '06', '07', '08', '09']
            # 6 row
        ]
...
if __name__ == '__main__':
    ...
    gen_pdf.build_Individui_sheets([["a", "HFF_system", "c", "d", "e", "f", "g", "h", "i", "l", "m"]])
