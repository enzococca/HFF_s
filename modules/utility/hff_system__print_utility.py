...
class Print_utility(QObject):
    ...
    def charge_layer_sqlite(self, sito, area, us):
        ...
        uri.setDataSource('', 'hff_system__us_view', 'the_geom', gidstr, "ROWID")
        self.layerUS = QgsVectorLayer(uri.uri(), 'hff_system__us_view', 'spatialite')
        ...
        uri.setDataSource('', 'hff_system__quote_view', 'the_geom', gidstr, "ROWID")
        self.layerQuote = QgsVectorLayer(uri.uri(), 'hff_system__quote_view', 'spatialite')
    ...
    def charge_layer_postgis(self, sito, area, us):
        ...
        self.uri.setDataSource("public", "hff_system__us_view", "the_geom", gidstr, 'gid')
        ...
        self.uri.setDataSource("public", "hff_system__quote", "the_geom", gidstr, 'gid')
